...
--
-- Name: create_default_tenant_features(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.create_default_tenant_features() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
...
--
-- Name: idx_orders_delivered_date; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_orders_delivered_date ON public.orders USING btree (delivered_at) WHERE (status = 'ENTREGUE'::public.order_status);
...
--
-- Name: idx_profiles_tenant_active; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: orders audit_order_status_changes; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER audit_order_status_changes AFTER UPDATE ON public.orders FOR EACH ROW EXECUTE FUNCTION public.log_order_status_change();


--
-- Name: tenants auto_create_tenant_features; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER auto_create_tenant_features AFTER INSERT ON public.tenants FOR EACH ROW EXECUTE FUNCTION public.create_default_tenant_features();
...
--
-- Name: tenant_features Admin master can manage all tenant features; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Admin master can manage all tenant features" ON public.tenant_features USING (public.has_role(auth.uid(), 'admin_master'::public.app_role));
...
--
-- Name: tenant_features Company admins can view own features; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Company admins can view own features" ON public.tenant_features FOR SELECT USING (((EXISTS ( SELECT 1
   FROM public.profiles
  WHERE ((profiles.id = auth.uid()) AND (profiles.tenant_id = tenant_features.tenant_id)))) AND public.has_role(auth.uid(), 'company_admin'::public.app_role)));
